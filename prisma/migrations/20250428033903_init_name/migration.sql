/*
  ...
  - You are about to drop the `costume_basess` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "costume_basess" DROP CONSTRAINT "costume_basess_obtains_base_uuid_fkey";

-- DropForeignKey
ALTER TABLE "costumes" DROP CONSTRAINT "costumes_costume_base_uuid_fkey";

-- DropTable
DROP TABLE "costume_basess";
